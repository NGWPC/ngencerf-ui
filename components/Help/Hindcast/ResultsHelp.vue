<template>
  <div class="_help-page">
    <div class="_help-title">Hindcast - Results Tab</div>
    <p id="help-subtitle" class="_help-subtitle">
      Displays results for the selected hindcast run.
    </p>
      ...
      <thead>
        ...
        <tbody>
               ...
               <td class="td1">Display</td>
                <td class="td2">Select the result to display in the main viewing area (e.g. time series or logs). 
                    <ul class="list-disc list-outside ml-6 space-y-0">
                        <li>Selecting <strong>Streamflow Time Series</strong> shows a slider at the bottom to zoom in or out. 
            ...
            <tr>
                ...
                <td class="td2">How far apart each cycle is spaced (e.g., every 6 hours).
                </td>
            </tr>
            <tr>
                <td class="td1">Number of Intervals</td>
                <td class="td2">How many cycles to generate at that spacing.<br />
                    For example:<br />
