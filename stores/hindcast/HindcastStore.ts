 ...
 * @return {void}
 */
  async function fetchCalibrationJobsForHindcastIdsOnly() {
    ...
    const runListDataResult = await makeProtectedApiCall<CalibrationRunsForHindcast>(`${ngencerfBaseUrl}/calibration/get_calibration_jobs_for_evaluation/`, {
      method: "POST",
      headers: {
        "Authorization": `Bearer ${getAccessToken()}`,
        "Content-Type": 'application/json'
